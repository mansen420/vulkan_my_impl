...
vk_handle::description::color_blend_desc get_color_no_blend_state_descr(std::vector<VkPipelineColorBlendAttachmentState> states)
{
...
std::vector<VkPipelineShaderStageCreateInfo> get_shader_stages(std::vector<vk_handle::description::shader_module_desc> module_descriptions, std::vector<VkShaderModule> module_handles)
{
...
vk_handle::description::renderpass_desc get_simple_renderpass_description(vk_handle::description::swapchain_features swp_features, VkDevice parent)
{
...
std::vector<vk_handle::description::device_queue> get_device_queues(vk_handle::description::queue_families fam_indices)
{
...
bool is_adequate(vk_handle::description::queue_families indices)
{
    return indices.graphics_fam.has_value() && indices.present_fam.has_value();
}
bool is_complete(vk_handle::description::queue_families indices)
{
    return is_adequate(indices) && indices.dedicated_transfer_fam.has_value();
}
vk_handle::description::swapchain_support get_swapchain_support(VkPhysicalDevice phys_device, VkSurfaceKHR surface)
{
...
vk_handle::description::queue_families find_queue_family(VkPhysicalDevice phys_device, VkSurfaceKHR surface)
{
